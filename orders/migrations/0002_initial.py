...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userservicediscount',
            name='service_option',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_discounts', to='orders.serviceoption'),
        ),
        migrations.AddField(
            model_name='userservicediscount',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_discounts', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterUniqueTogether(
            name='userservicediscount',
